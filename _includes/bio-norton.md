...
{% include figure image_path="/images/norton-profile.png" caption="Figure 1: Ο Νόρτον ήταν προγραμματιστής στα συστήματα IBM PC και είναι γνωστός για την παραγωγή μερικών διάσημων λογισμικών όπως το Norton Ultilities, Norton Commander." id="fig:norton-profile" %}
